<template>
    <div class="ads section dark">
        ...
        <div class="ads__content content-centered">
            <div class="ads__row">
                <p class="whitespace-large">Пока вы слышите, что сейчас не время масштабироваться, ведь: закрыли социальные сети Цукерберга, отключили таргет, у клиентов нет денег, подписчики читают только новости, мы растим бизнесы клиентов и делаем им медийность!</p>
            </div>
            <div class="ads__row">
                ...
                <ul class="list --no-offset" role="list">
                    <li class="list__item">
                        <p>Cнизили расходы на все, что можно было</p>
                        <p>(в первую очередь на маркетинг),</p>
                    </li>
                    <li class="list__item">
                        <p>Заморозили / закрыли бизнес,</p>
                    </li>
                    <li class="list__item">
                        <p>Передумали продвигаться,</p>
                    </li>
                    <li class="list__item">
                        <p>Отложили проекты до лучших времен,</p>
                    </li>
                </ul>
            </div>
            <div class="ads__row">
            ...
            <div class="ads__row">
                ...
                <ul class="list --no-offset" role="list">
                    <li class="list__item">
                        <p>Оставшиеся деньги дешевеют каждый день,</p>
                    </li>
                    <li class="list__item">
                        <p>Вашу нишу займут конкуренты,</p>
                        <p>которые воспользуются ситуацией.</p>
                    </li>
                </ul>
            </div>
        </div>
